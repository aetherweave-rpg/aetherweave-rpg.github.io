...
window.CHANGELOG_CONTENT = [
  ...
  },
  {
    ...
    entries: [
      ...
      "Changed talent \"Butterfly Kick\" (tier 2) in the Brawling domain: description: \"When you Evade or Dodge, and the attacker is in melee range,...\" -> \"When you Dodge, and the attacker is in melee range, make an...\".",
      "Changed defining trait \"Clockwork Physiology\" in the the catalogue catalogue: description: \"You add an additional dice to any Endure tests.\" -> \"You add an additional dice to any Body + Resist tests.\".",
      "Added skill/proficiency \"Deceive\".",
      "Added skill/proficiency \"Entertain\".",
      "Added skill/proficiency \"Knowledge: Arcane\".",
      "Added skill/proficiency \"Knowledge: Divine\".",
      "Added skill/proficiency \"Knowledge: Natural World\".",
      "Added skill/proficiency \"Knowledge: Occult\".",
      "Added skill/proficiency \"Knowledge: Society\".",
      "Added skill/proficiency \"Listen\".",
      "Added skill/proficiency \"Persuasion\".",
      "Added skill/proficiency \"Sail\".",
      "Added skill/proficiency \"Search\".",
      "Added skill/proficiency \"Sneak\".",
      "Added skill/proficiency \"Strength\".",
      "Added skill/proficiency \"Survival\".",
      "Added skill/proficiency \"Swim\".",
      "Removed skill/proficiency \"Endure\".",
      "Removed skill/proficiency \"Evade\".",
      "Removed skill/proficiency \"Ward\".",
      "Removed skill/proficiency \"Arcane\".",
      "Removed skill/proficiency \"Athletics\".",
      "Removed skill/proficiency \"Divine\".",
      "Removed skill/proficiency \"Lie\".",
      "Removed skill/proficiency \"Nature\".",
      "Removed skill/proficiency \"Occult\".",
      "Removed skill/proficiency \"Sneaking\".",
      "Removed skill/proficiency \"Society\".",
      "Removed skill/proficiency \"Swimming\".",
      "Removed skill/proficiency \"Wilderness\".",
    ],
  },
  {
    date: "2026-08-28",
