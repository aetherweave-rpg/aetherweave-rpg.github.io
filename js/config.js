...
window.CONFIG = {
  ...
  // costs SKILL_COSTS.combat[R-1] from the COMBAT pool. Owning rung R unlocks
  // casting tier-R spells; beside each rung a free "Spells Known" node opens that
  // tier's spell picker. Individual spells (js/data/spells.js) carry their own
  // exp `cost`/`pool` and a `mana` cost to cast (tier-1 spells are free cantrips).
  //
